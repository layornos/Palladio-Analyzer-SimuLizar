...
import org.palladiosimulator.simulizar.interpreter.listener.AbstractProbeBehaviourSeffListener;
...
public class ProbeBehaviourSeffListenerForElasticity extends AbstractProbeBehaviourSeffListener
		implements IListenerForElasticity {

	private static final Logger LOGGER = Logger.getLogger(ProbeBehaviourSeffListenerForElasticity.class);

	public ProbeBehaviourSeffListenerForElasticity(PCMPartitionManager pcmPartitionManager, SimuComModel simuComModel,
