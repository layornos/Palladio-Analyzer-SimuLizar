...
import org.palladiosimulator.simulizar.interpreter.listener.AbstractProbeRepositoryListener;
...
public class ProbeFrameworkRepositoryListenerForElasticity extends AbstractProbeRepositoryListener
		implements IListenerForElasticity {
	private static final Logger LOGGER = Logger.getLogger(ProbeFrameworkRepositoryListenerForElasticity.class);

	public ProbeFrameworkRepositoryListenerForElasticity(PCMPartitionManager pcmPartitionManager,
