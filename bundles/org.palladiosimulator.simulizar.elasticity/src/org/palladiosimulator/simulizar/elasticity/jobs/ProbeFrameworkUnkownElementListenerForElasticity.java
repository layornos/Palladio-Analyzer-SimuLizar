...
import org.palladiosimulator.simulizar.interpreter.listener.AbstractProbeUnkownElementListener;
...
public class ProbeFrameworkUnkownElementListenerForElasticity extends AbstractProbeUnkownElementListener
		implements IListenerForElasticity {

	private static final Logger LOGGER = Logger.getLogger(ProbeFrameworkUnkownElementListenerForElasticity.class);

	public ProbeFrameworkUnkownElementListenerForElasticity(PCMPartitionManager pcmPartitionManager,
			SimuComModel simuComModel, Reconfigurator reconfigurator) {
