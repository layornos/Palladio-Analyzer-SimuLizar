...
public class ProbeFrameworkBehaviourSeffListener extends AbstractProbeBehaviourSeffListener {

	private static final Logger LOGGER = Logger.getLogger(ProbeFrameworkBehaviourSeffListener.class);

	public ProbeFrameworkBehaviourSeffListener(PCMPartitionManager pcmPartitionManager, SimuComModel simuComModel,
