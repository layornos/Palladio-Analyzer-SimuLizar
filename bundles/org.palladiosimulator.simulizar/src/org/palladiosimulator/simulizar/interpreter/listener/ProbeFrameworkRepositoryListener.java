	...
	public class ProbeFrameworkRepositoryListener extends AbstractProbeRepositoryListener {

		private static final Logger LOGGER = Logger.getLogger(ProbeFrameworkRepositoryListener.class);

		public ProbeFrameworkRepositoryListener(PCMPartitionManager pcmPartitionManager, SimuComModel simuComModel,
