 ...
 *
 */
public class DomainTransitionDeterminer extends ParadigmTransitionDeterminer {

    protected static final Logger LOGGER = Logger.getLogger(DomainTransitionDeterminer.class.getName());
     ...
     */
    public DomainTransitionDeterminer(final InterpreterDefaultContext context) {
        super(context);
    }
    ...
    private GuardedBranchTransition determineGuardedBranchTransition(
            final EList<GuardedBranchTransition> guardedBranchTransitions) {
        ...
        for (final GuardedBranchTransition abstractBranchTransition : guardedBranchTransitions) {
    ...
    protected List<Double> extractProbabiltiesRDSEFF(
            final EList<ProbabilisticBranchTransition> probabilisticBranchTransitions) {
        final List<Double> probabilityList = new ArrayList<Double>();
        for (final ProbabilisticBranchTransition probabilisticBranchTransition : probabilisticBranchTransitions) {
