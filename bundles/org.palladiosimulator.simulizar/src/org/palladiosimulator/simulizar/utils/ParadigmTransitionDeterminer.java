 ...
 *
 */
public class ParadigmTransitionDeterminer {

    protected static final Logger LOGGER = Logger.getLogger(ParadigmTransitionDeterminer.class.getName());

    protected final SimuComConfig config;
     ...
     */
    public ParadigmTransitionDeterminer(final InterpreterDefaultContext context) {
        super();
